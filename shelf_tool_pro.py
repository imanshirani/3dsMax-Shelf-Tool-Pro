...
class ShelfTool(QWidget):
    def __init__(self):
        ...
        # Load settings
        self.settings_path = os.path.join(os.path.expanduser("~"), "Documents", "3dsMaxShelves", "settings.ini")
        self.shelves_save_path = None
        self.icon_size = 32
    ...
    def open_settings_dialog(self):
        ...
        def save_all_settings():
            ...
            self.save_shelves_to_file(self.shelves_save_path)
            elf.settings_path = settings_path_edit.text()
            self.save_settings_to_ini()
            dialog.accept()
